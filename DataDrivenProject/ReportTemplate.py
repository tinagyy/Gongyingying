...
def htmlTemplate(trData):
    ...
    body{
        ...
        fount- family:'trebuchet MS','Lucida sans',SimSun; /*表格中文字的字体类型*/
        font - size:18px;  /* 整个body区域占浏览器的宽度百分比*/
        color:# 000;        /* 整个body区域占浏览器的宽度百分比*/
    }
    table{
    ...
    .tableStyle th{
        ...
        /*表格标题栏设置渐变颜色*/
        background - image: - webkit -gradient(liear,left top,left bottom,from(# 92D050),to(# A2D668));
         /*rgb(146,208,80)*/
    }
    </style>
    </head>
    ...
    print html
    # 生成.html文件
    with open(r"E:\testTemplate.html","w") as fp:
